...
*/
 ...
 Serial.print("t                          : ");
 Serial.println(t);
 Serial.print("temperature mesuree T     : ");
 Serial.print(T, 2);//Température mesurée T en °C sur le couvercle de la casserole
 ...
 //4j - Visualisation du contenu des échantillons
  ...
  Serial.println("t;T (degres C);Tcons (degres C);Dich (s);Ach;Dur (mn))");
  }
