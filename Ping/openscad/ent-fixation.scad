$fn=100;
difference() {
color([206/255,206/255,206/255]) linear_extrude(height = 10, center = true, convexity = 10, scale = 1.0) {import(file = "/home/airel/SCAO/Ping/LibreCAD/ent-fixation.dxf", layer = "contour-dessous");};
