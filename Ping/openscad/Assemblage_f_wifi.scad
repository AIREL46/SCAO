...
union()translate([-28,0,z3+$t*(z3_e-z3)]){
//Platine breadboard (3b)
color(bleu)translate([50,0,z3b+$t*(z3b_e-z3b)]) linear_extrude(height = 10, center = true, convexity = 10, scale = 1.0) {import(file = "../LibreCAD/plateforme-essais-wifi.dxf", layer = "breadboard");};
//Plateforme microcontrôleur 1010 (3a)
color()translate([50,0,z3b+$t*(z3b_e-z3b)]) linear_extrude(height = 1, center = true, convexity = 10, scale = 1.0) {import(file = "../LibreCAD/plateforme-essais-wifi.dxf", layer = "micro");};
//Battery
color([255/255, 0/255, 0/255])translate([50,0,z3b+$t*(z3b_e-z3b)-2]) linear_extrude(height = 4, center = true, convexity = 10, scale = 1.0) {import(file = "../LibreCAD/plateforme-essais-wifi.dxf", layer = "batterie");};
//Capteur de température (7)
translate([-62,15,z3b+$t*(z3b_e-z3b)+2])rotate([90,90,0]){import("capteur.stl");}
//Plateforme d'essais (3g)
include <plateforme-essais-wifi.scad>
//Rondelle M2.5 (3h)
...
//Jupe (8)
translate([0,0,z8+$t*(z8_e-z8)])color( vert){import("jupe_wifi_coupe.stl");}
//entretoises M3 (9)
