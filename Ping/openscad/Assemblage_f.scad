...
//vis M3 (1)
color( gris)vis_M(3, 5, 1.5, true, L2/2, l2/2, z1);
color( gris)vis_M(3, 5, 1.5, true, -L2/2, l2/2, z1);
color( gris)vis_M(3, 5, 1.5, true, L2/2, -l2/2, z1);
color( gris)vis_M(3, 5, 1.5, true, -L2/2, -l2/2, z1);
//Rondelles (2)
rond_M(3, 0.5, L2/2, l2/2, z2);
rond_M(3, 0.5, L2/2, -l2/2, z2);
rond_M(3, 0.5, -L2/2, l2/2, z2);
rond_M(3, 0.5, -L2/2, -l2/2, z2);
...
color( gris) translate([0,0,z5]) union() {difference(){
    translate([L2/2,l2/2,0]) cylinder(10,3,3,center=true);
    translate([L2/2,l2/2,0]) cylinder(1.1*10,1.6,1.6,center=true);
    }
    difference(){
    translate([L2/2,-l2/2,0]) cylinder(10,3,3,center=true);
    translate([L2/2,-l2/2,0]) cylinder(1.1*10,1.6,1.6,center=true);
...
rond_M(3, 0.5, -8.5, -8.5, z11);
//isolateur (12)
translate([0,0,z12])color(orange)linear_extrude(height = 2, center = true, convexity = 10, scale = 1.0) {import(file = "/home/leruste/SCAO/Ping/LibreCAD/isolateur-433-v2.dxf", layer = "contour");};
